...
def parse_args():
    ...
    parser.add_argument('--resume', type=str, default='none', help='Weights resumed in testing and evaluation')
...
if __name__ == '__main__':
    ...
    down_ratio = 4
    model = ctrbox_net_seg.CTRBOX_mmsegmentationV5(heads=heads,
                              pretrained=True,
