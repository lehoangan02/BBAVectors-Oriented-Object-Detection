...
def parse_args():
    ...
    parser.add_argument('--num_workers', type=int, default=48, help='Number of workers')
    ...
    parser.add_argument('--resume', type=str, default='model_55.pth', help='Weights resumed in testing and evaluation')
